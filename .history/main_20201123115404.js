...
let tCosts = webDevCost.value + carsVans.value + rentRates.value + initialStockPurchase.value + bizReg.value + initialMarketing.value + companyIdentity.value +
    insurance.value + tradeSub.value + vehicleMtnce.value + utilityCost.value + wageSalaries.value + accounting.value + marketing.value +
    stationery.value + travelEntmnt.value + pensionMedical.value + staffSubs.value + stockPurchase.value + otherCost.value;
...
calculate.addEventListener('click', function(){
    ...
    let totalB = parseFloat(webDevCost.value) + parseFloat(carsVans.value) + parseFloat(rentRates.value) + parseFloat(initialStockPurchase.value) + parseFloat(bizReg.value);
    totalCosts.textContent = parseFloat(webDevCost.value) + parseFloat(carsVans.value) + parseFloat(rentRates.value) + parseFloat(initialStockPurchase.value) + parseFloat(bizReg.value) ;
