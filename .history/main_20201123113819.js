...
let initialValue = 0;
let costs = 
    [webDevCost.value, carsVans.value, rentRates.value, initialStockPurchase.value, bizReg.value, initialMarketing, companyIdentity,
...
calculate.addEventListener('click', function(){
    ...
    let totalB = costs.reduce((a, b) => a + b, 0);
