...
calculate.addEventListener('click', function(){
    ...
    alert('Hi');
    console.log(webDevCost.value);
    // let totalCosts = [];
    // console.log(webDevCost.value, carsVans.value, rentRates.value, initialStockPurchase.value, bizReg.value, initialMarketing.value, companyIdentity.value);	
});
